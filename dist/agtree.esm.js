  ...
  static parse(raw, loc = defaultLocation) {
    ...
    if (injection.type === CssTreeNodeType.Atrule) {
      ...
      if (!atrule.prelude || atrule.prelude.type !== CssTreeNodeType.AtrulePrelude) {
        ...
        throw new AdblockSyntaxError(
        // eslint-disable-next-line max-len
        `Invalid at-rule prelude, expected '${CssTreeNodeType.AtrulePrelude}' but got '${((_atrule$prelude = atrule.prelude) === null || _atrule$prelude === void 0 ? void 0 : _atrule$prelude.type) ?? NONE}' instead`, {
      ...
      if (!atrule.block || atrule.block.type !== CssTreeNodeType.Block) {
        ...
        throw new AdblockSyntaxError(
        // eslint-disable-next-line max-len
        `Invalid at-rule block, expected '${CssTreeNodeType.Block}' but got '${((_atrule$block = atrule.block) === null || _atrule$block === void 0 ? void 0 : _atrule$block.type) ?? NONE}' instead`, {
