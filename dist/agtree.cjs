...
var CssTree = /*#__PURE__*/function () {
  ...
  _createClass(CssTree, null, [{
    ...
    function shiftNodePosition(root) {
      var loc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultLocation;
      ecssTree.walk(root, function (node) {
        if (node.loc) {
    ...
    value: function parse(raw, context) {
      ...
      try {
        ...
        return CssTree.shiftNodePosition(ecssTree.parse(raw, _objectSpread(_objectSpread({
          context: context
    ...
    value: function getSelectorExtendedCssNodes(selectorList) {
      ...
      ecssTree.walk(ast, function (node) {
    ...
    value: function hasAnySelectorExtendedCssNode(selectorList) {
      ...
      // TODO: CSSTree types should be improved, as a workaround we use `any` here
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      return ecssTree.find(ast, function (node) {
    ...
    value: function parsePseudoClassArgumentAsNumber(node) {
      ...
      if (argument.type !== exports.CssTreeNodeType.String && argument.type !== exports.CssTreeNodeType.Number && argument.type !== exports.CssTreeNodeType.Raw) {
        throw new Error("Invalid argument '".concat(node.name, "', expected a ").concat(exports.CssTreeNodeType.String, " or ").concat(exports.CssTreeNodeType.Number, " or ").concat(exports.CssTreeNodeType.Raw, ", but got '").concat(argument.type, "'"));
      }
...
var ElementHidingBodyParser = /*#__PURE__*/function () {
  ...
  _createClass(ElementHidingBodyParser, null, [{
    ...
    function parse(raw) {
      var loc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultLocation;
      // eslint-disable-next-line max-len
      var selectorList = CssTree.parsePlain(raw, exports.CssTreeParserContext.selectorList, false, loc);
      return {
...
var CssInjectionBodyParser = /*#__PURE__*/function () {
  ...
  _createClass(CssInjectionBodyParser, null, [{
    ...
    value: function parseUboStyleInjection(raw) {
      var loc = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : defaultLocation;
      var selectorList = CssTree.parse(raw, exports.CssTreeParserContext.selectorList, false, loc);
      ...
      if (selectorList.type !== exports.CssTreeNodeType.SelectorList) {
        throw new AdblockSyntaxError( // eslint-disable-next-line max-len
        "Invalid selector list, expected '".concat(exports.CssTreeNodeType.SelectorList, "' but got '").concat(selectorList.type || NONE, "' instead"), locRange(loc, 0, raw.length));
      }
      ...
      var _loop = function _loop() {
        ...
        if (selector.type !== exports.CssTreeNodeType.Selector) {
          ...
          throw new AdblockSyntaxError( // eslint-disable-next-line max-len
          "Invalid selector, expected '".concat(exports.CssTreeNodeType.Selector, "' but got '").concat(selector.type || NONE, "' instead"), {
        ...
        if (i !== selectors.length - 1) {
          ...
          ecssTree.walk(selector, function (node) {
            // eslint-disable-next-line max-len
    ...
    value: function parse(raw) {
      ...
      var stylesheet = CssTree.parse(raw, exports.CssTreeParserContext.stylesheet, true, loc);
      // Check stylesheet
      if (stylesheet.type !== exports.CssTreeNodeType.StyleSheet) {
        ...
        throw new AdblockSyntaxError("Invalid stylesheet, expected '".concat(exports.CssTreeNodeType.StyleSheet, "' but got '").concat(stylesheet.type, "' instead"), {
      ...
      if (injection.type !== exports.CssTreeNodeType.Rule && injection.type !== exports.CssTreeNodeType.Atrule) {
        ...
        throw new AdblockSyntaxError( // eslint-disable-next-line max-len
        "Invalid injection, expected '".concat(exports.CssTreeNodeType.Rule, "' or '").concat(exports.CssTreeNodeType.Atrule, "' but got '").concat((_injection$type = injection.type) !== null && _injection$type !== void 0 ? _injection$type : NONE, "' instead"), {
      ...
      if (injection.type === exports.CssTreeNodeType.Atrule) {
        ...
        if (!atrule.prelude || atrule.prelude.type !== exports.CssTreeNodeType.AtrulePrelude) {
          ...
          throw new AdblockSyntaxError( // eslint-disable-next-line max-len
          "Invalid at-rule prelude, expected '".concat(exports.CssTreeNodeType.AtrulePrelude, "' but got '").concat((_atrule$prelude$type = (_atrule$prelude = atrule.prelude) === null || _atrule$prelude === void 0 ? void 0 : _atrule$prelude.type) !== null && _atrule$prelude$type !== void 0 ? _atrule$prelude$type : NONE, "' instead"), {
        ...
        if (!atrule.block || atrule.block.type !== exports.CssTreeNodeType.Block) {
          ...
          throw new AdblockSyntaxError( // eslint-disable-next-line max-len
          "Invalid at-rule block, expected '".concat(exports.CssTreeNodeType.Block, "' but got '").concat((_atrule$block$type = (_atrule$block = atrule.block) === null || _atrule$block === void 0 ? void 0 : _atrule$block.type) !== null && _atrule$block$type !== void 0 ? _atrule$block$type : NONE, "' instead"), {
      ...
      ecssTree.walk(rule.prelude, function (node) {
        if (node.type === exports.CssTreeNodeType.PseudoClassSelector) {
          if (node.name === REMOVE) {
    ...
    key: "generate",
    value: function generate(ast) {
      var syntax = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : exports.AdblockSyntax.Adg;
      var result = EMPTY;
    ...
    value: function parse(raw) {
      ...
      try {
        ...
        if (error instanceof Error && error.message.indexOf('Selector is expected') !== -1) {
          var ast = CssTree.parsePlain(escapedRawBody, exports.CssTreeParserContext.value, false, loc);
          if (ast.type !== 'Value') {
...
var CosmeticRuleParser = /*#__PURE__*/function () {
  ...
  _createClass(CosmeticRuleParser, null, [{
    ...
    value: function parse(raw) {
      ...
      var syntax = exports.AdblockSyntax.Common;
      ...
      switch (separatorResult.separator) {
        ...
        case '#@$?#':
          ...
          if (['#$#', '#@$#'].includes(separator.value)) {
            ...
            return {
              ...
              domains: domains,
              separator: separator,
              body: _objectSpread(_objectSpread({}, ScriptletInjectionBodyParser.parse(rawBody, exports.AdblockSyntax.Abp, shiftLoc(loc, bodyStart))), {}, {
                raw: rawBody
              })
            };
          }
        ...
        case '#@#+':
          ...
          return {
            ...
            domains: domains,
            separator: separator,
            body: _objectSpread(_objectSpread({}, ScriptletInjectionBodyParser.parse(rawBody, exports.AdblockSyntax.Ubo, shiftLoc(loc, bodyStart))), {}, {
              raw: rawBody
            })
          };
...
var DomainUtils = /*#__PURE__*/function () {
  ...
  _createClass(DomainUtils, null, [{
    ...
    function isValidDomainOrHostname(domain) {
      ...
      var tldtsResult = tldts.parse(domainToCheck);
